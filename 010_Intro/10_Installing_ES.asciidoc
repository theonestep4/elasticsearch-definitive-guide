...
Marvel can also be installed using a https://www.elastic.co/guide/en/marvel/current/_installation.html#manual_download[manual process] if you don't have internet connectivity.
...
An Elasticsearch _node_ is now ready to run. ((("Elasticsearch", "running")))You can start it up in the foreground
with this:
